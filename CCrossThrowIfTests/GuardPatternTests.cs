...
public class GuardPatternTests
{
    ...
    [Fact]
    public void Matches_WithNull_ThrowsArgumentNullException()
    {
        const string pattern = @"^[A-Z]{3}\d{3}$";
        
        Assert.Throws<ArgumentNullException>(() => 
            Guard.Pattern.Matches(null, pattern));
    }
    ...
    [Fact]
    public void Length_WithNull_ThrowsArgumentNullException()
    {
        Assert.Throws<ArgumentNullException>(() => 
            Guard.Pattern.Length(null, 3, 10));
    }
